package com.alibaba.datax.plugin.writer.jxwriter.util;
...
import com.alibaba.datax.plugin.writer.jxwriter.JXWriterErrorCode;
...
public class SftpHelperImpl implements IFtpHelper {
        ...
        try {
            ...
            if (this.session == null) {
                throw DataXException
                        .asDataXException(JXWriterErrorCode.FAIL_LOGIN,
            ...
            if (null != e.getCause()) {
                ...
                LOG.error(message);
                throw DataXException.asDataXException(
                        JXWriterErrorCode.FAIL_LOGIN, message);
            }
        }
    ...
    public void mkdir(String directoryPath) {
        ...
        if (!isDirExist) {
            try {
                ...
                throw DataXException
                        .asDataXException(
                                JXWriterErrorCode.COMMAND_FTP_IO_EXCEPTION,
                                message, e);
            }
        }
    }
    ...
    public OutputStream getOutputStream(String filePath) {
        try {
            ...
            if (null == writeOutputStream) {
                throw DataXException.asDataXException(
                        JXWriterErrorCode.OPEN_FILE_ERROR, message);
            }
    ...
    public Set<String> getAllFilesInDir(String dir, String prefixFileName) {
        ...
        try {
            ...
            LOG.error(message);
            throw DataXException.asDataXException(
                    JXWriterErrorCode.COMMAND_FTP_IO_EXCEPTION, message, e);
        }
    ...
    @Override
    public boolean renameFile(String oldPath, String newPath) throws SftpException {
