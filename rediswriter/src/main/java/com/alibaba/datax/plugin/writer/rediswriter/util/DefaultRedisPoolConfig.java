...
public class DefaultRedisPoolConfig extends JedisPoolConfig{
    ...
    private JedisPoolConfig defaultRedisPoolConfig;
    ...
    private DefaultRedisPoolConfig() {
        this.defaultRedisPoolConfig = new DefaultRedisPoolConfig();
...
//        <!-- 连接耗尽时是否阻塞, false报异常,ture阻塞直到超时, 默认true -->
    ...
    public static JedisPoolConfig getInstance(){
        return (new DefaultRedisPoolConfig()).getDefaultRedisPoolConfig();
    }
